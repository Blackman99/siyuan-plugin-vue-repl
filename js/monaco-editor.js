...
import { C as CancellationTokenSource, E as Emitter, K as KeyCode, a as KeyMod, M as MarkerSeverity, b as MarkerTag, P as Position, R as Range, S as Selection, c as SelectionDirection, T as Token, U as Uri, e as editor, l as languages, i as initMonaco, g as getOrCreateModel } from './chunks/env-ef5192aa.js';
...
const loadTheme = async (editor) => {
  const themes = await import('./chunks/index2-40409951.js');
  return themes.loadTheme(editor);
};
const loadGrammars = async (monaco, editor) => {
  const grammars = await import('./chunks/index3-239899ce.js');
